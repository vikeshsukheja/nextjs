...
<br></br>
    ...
    <ul>
      <li>Runtime Logs: Runtime logs allow you to search, inspect, and share your team's runtime logs at a project level. You can search runtime logs from the deployments section inside the Vercel dashboard. Your log data is retained for 3 days. For longer log storage, you can use log drains.</li>
      <li>Web Analytics: Web Analytics empowers you with in-depth insights into your website's visitors, showcasing metrics such as top pages, referrers, and demographic data like countries, operating systems, and browser usage.</li>
      <li>Speed Insights: Vercel Speed Insights provides a convenient way to analyze your site's performance metrics directly within the dashboard, without the need to modify your code. Easily view and filter data based on device type, user percentiles, and reporting windows to better understand and optimize your site's speed and user experience.</li>
      ...
      <li>Activity Logs: Activity Logs provide chronologically organized events on your personal or team account. You get an overview of changes to your environment variables, deployments, and more.</li>
      <li>Audit Logs: Audit Logs allow owners to track events performed by other team members. The feature helps you verify who accessed what, for what reason, and at what time. You can export up to 90 days of audit logs to a CSV file.</li>
      ...
      <li>Open Telemetry Collector: Vercel's OpenTelemetry (OTEL) collector enables seamless transmission of OTEL traces from your Serverless Functions to APM vendors like New Relic. Traces provide valuable insights into your application's performance, helping pinpoint and resolve issues.</li>
    </ul>
 <br></br>
